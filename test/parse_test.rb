...
class ParseTest < Minitest::Spec
  ...
  it "works with PRO's JSON format" do
    ...
    collaboration = Trailblazer::Workflow::Parse::Representer::Collaboration.new(OpenStruct.new).from_json(moderation_json)
  ...
  it do
    ...
    signal, (ctx, _) = Trailblazer::Workflow::Parse.invoke([{json_document: moderation_json}, {}])
